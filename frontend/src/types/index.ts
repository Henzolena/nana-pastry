export interface Cake {
  ...
  bakerId?: string; // Optional: ID of the baker who manages this cake
  featured: boolean;
  ingredients?: string[];
...
// Corresponds to backend CreateCakeDto
export interface FrontendCreateCakeDto {
  name: string;
  category: CakeCategory;
  description: string;
  price: number;
...
// Corresponds to backend UpdateCakeDto
export type FrontendUpdateCakeDto = Partial<FrontendCreateCakeDto>;
