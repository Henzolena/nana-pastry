...
import { ApiTestComponent } from '@/components/ApiTestComponent'; // Import API test component
import { useAuthCheck } from '@/hooks/useAuth'; // Import our new auth check hook
