...
const CakeDetailsModal = ({ cake, isOpen, onClose }: CakeDetailsModalProps) => {
  ...
  // Ensure images is always an array, and provide a fallback for display
  const displayImages = (cake.images && cake.images.length > 0) ? cake.images : (cake.imageUrl ? [cake.imageUrl] : ['/placeholder-cake.jpg']);
        ...
        <div>
          <div className="relative overflow-hidden rounded-xl h-80">
            <img 
              ...
              onError={(e) => (e.currentTarget.src = '/placeholder-cake.jpg')} // Fallback for broken image links in gallery
            />
              ...
              {displayImages.map((img, index) => (
                ...
                >
                  <img 
                    ...
                    className="w-full h-full object-cover" 
                    onError={(e) => (e.currentTarget.src = '/placeholder-cake.jpg')} // Fallback for thumbnails
                  />
                </button>
              ))}
            </div>
